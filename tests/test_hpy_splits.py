"""Tests for vectorized hpy_cell_splits / hpy_splits.

Equivalence cases compare against the frozen pre-rewrite loop. The standalone
hl=1 case asserts hand-checked tokens and does not call the original.
