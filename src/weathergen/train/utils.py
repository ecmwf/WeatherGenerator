...
def get_active_stage_config(
    ...
    # date_ranges must not leak from base into a stage that overrides start_date/end_date
    if "date_ranges" in base_config and (
        "start_date" in merge_config or "end_date" in merge_config
    ):
