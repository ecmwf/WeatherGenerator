...
if __name__ == "__main__":
    r = RegularDataset("/work/ab0995/a270225/atmorep_data/zarr/multiverse_y1958_2019_res100_chunk8_cycle4.zarr", datetime(year=1960, month=1, day=1), datetime(year=1999, month=12, day=31), 5)
