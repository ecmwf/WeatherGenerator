...
def rotary_pos_emb_spherical(
    ...
    """Apply spherical-harmonic RoPE modulation to q/k with precomputed coefficients."""
...
def build_spherical_rope_coeff_tensors(
    ...
    """Build spherical-RoPE coefficient tensors for cell, extra, and packed tokens."""
