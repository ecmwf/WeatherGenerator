...
class ForecastingEngine:
    ...
    def __init__(self, cf: Config, num_healpix_cells: int) -> None:
        ...
        if self.cf.forecast_diffusion:
            assert hasattr(self.cf, 'fe_diff_sigma_min') and self.cf.fe_diff_sigma_min is not None, "fe_diff_sigma_min must be set if forecast_diffusion is True"
            assert hasattr(self.cf, 'fe_diff_sigma_max') and self.cf.fe_diff_sigma_max is not None, "fe_diff_sigma_max must be set if forecast_diffusion is True"
            assert hasattr(self.cf, 'fe_diff_sigma_data') and self.cf.fe_diff_sigma_data is not None, "fe_diff_sigma_data must be set if forecast_diffusion is True"    
