            ...
            if si["embed"]["net"] == "transformer":
                self.embeds.append(
                    StreamEmbedTransformer(
                        ...
                        num_queries=si["embed"]["cross_attention"]["num_queries"],
                        cross_attn_num_blocks=si["embed"]["cross_attention"]["num_blocks"],
                        cross_attn_num_heads=si["embed"]["cross_attention"]["num_heads"],
